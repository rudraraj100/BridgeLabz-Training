...
// create a class BonusSalary represents total salary bonus 
public class BonusSalary{
   public static void main(String[] args){
	  ...
	  int salary = sc.nextInt();
		...
		// if else statement used to determine and display only 5 or more years of service by user can get bonus only
		if( service >= 5){
